...
<figure class="media">
  <img src="{{media}}/curso-1/segurancas.webp" alt="Cinco círculos ilustrados: um ouvido com ondas sonoras e pessoas em volta (acolhida); cédula e moeda com pessoas trabalhando (renda); pessoas de várias idades convivendo em um parque (convívio); pessoas subindo degraus, com formatura e cadeira de rodas (autonomia); aperto de mãos com pessoas recebendo alimentos (apoio e auxílio)" />
...
<figure class="media">
  <img src="{{media}}/curso-1/niveis-de-protecao.webp" alt="Em cima, famílias e comunidade reunidas em volta de uma casa feita de blocos, sob um guarda-chuva de folhas verdes. Abaixo, uma seta aponta para um escudo com uma mão segurando uma muda de planta" />
...
<figure class="media">
  <img src="{{media}}/curso-1/mapa-processos.webp" alt="Fluxo ilustrado em etapas ligadas por setas: uma mão recebendo uma estrela; uma casa com um coração; duas pessoas conversando com balões de fala; duas pessoas em diálogo; uma balança em equilíbrio; e uma família com plantas crescendo ao lado" />
